...
###################################################################
# THIS PAGE IS A MESS. I AUTOGENERATED MOST OF IT USING TOOLS.  
###################################################################
...
def create_profile(): 
    ...
    project.short_description = 'Generates text - like lorem ipsum - ' \
        'but uses real English. Taken from random samplings of dialog ' \
        'spoken by Commander William Riker in Star Trek: The Next Generation'
    ...
    project.long_description = '<p>The intent of this utility is to make ' \
        ...
        '</ul>'
    project.deployment_url =  'https://github.com/ben174/mytush'
    project.src_url = 'https://github.com/ben174/mytush'
    project.sort_order = sort_order
    sort_order += 1
    project.save()

    project = Project(name='My Resume')
    project.short_description = 'A Django project which hosts my resume.'
    project.long_description = '<p>My resume itself was a project of its own. ' \
        'Written in Python/Django - it makes it way easier to maintain my ' \
        'profile. And since all the data is stored in a database - it is ' \
        'easy to export my resume in any format.</p> '\
        '<p>I have released the source on GitHub for '\
        'anyone to view and/or use.</p>'
    project.deployment_url = 'http://www.bugben.com'
    project.src_url = 'https://github.com/ben174/bugben'
    project.sort_order = sort_order
    sort_order += 1
    project.save()
    ...
    ProfileEntry.objects.create(
        entry='Senior software/systems engineer with twelve years of professional experience.', 
    ...
    ProfileEntry.objects.create(
        entry='Unique mix of software engineering and systems administration.',
        sort_order=sort_order,
    )
    ...
    ProfileEntry.objects.create(
        entry='Possess a wide range of technical knowledge in many areas, specializing in software architecture and development.',
        sort_order=sort_order,
    )
    ...
    ProfileEntry.objects.create(
        entry='Extremely knowledgeable of the Linux operating system, along with various applications and tools commonly used in a Linux environment.',
        sort_order=sort_order,
    )
    ...
    ProfileEntry.objects.create(
        entry='Twelve years of experience in the analysis, design and development of both commercial and custom software.',
        sort_order=sort_order,
    )
    ...
    ProfileEntry.objects.create(
        entry='Red Hat Certified Engineer and Red Hat Certified Systems Administrator (Certification ID: 120-054-903)',
        sort_order=sort_order,
    )
    ...
    ProfileEntry.objects.create(
        entry='Proficient in object design patterns, problem solving and identifying/avoiding anti-patterns.',
        sort_order=sort_order,
    )
    ...
    ProfileEntry.objects.create(
        entry='Very strong analytical, oral, and written communication skills.',
        sort_order=sort_order,
    )
    ...
    ProfileEntry.objects.create(
        entry='Contributor and supporter of various open source software projects.',
        sort_order=sort_order,
    )
    ...
    entry.entry_details = 'Python, ColdFusion, PHP, Perl, JavaScript, Microsoft .NET, C#, SQL'
    entry.sort_order = sort_order
    entry.save()
    ...
    entry.entry_details = 'MySQL, PostgreSQL, Microsoft SQL Server 2000-2008, Oracle: 8i - 9i - 10g'
    entry.sort_order = sort_order
    entry.save()
    ...
    entry.entry_details = 'JSON, XML, XSL, AJAX, JavaScript, HTML, HTML 5, XHTML, CSS, JQuery, Scriptaculous, ASP, VBScript, Bash (shell scripting), VIM, SQL, PL/SQL, T-SQL, ORM (Hibernate/NHibernate), GIT, Heroku, Amazon EC2, Apache, GIS, Reporting, Video/Audio Processing and Production'
    entry.sort_order = sort_order
    entry.save()
    ...
    ImportantLink.objects.create(
        ...
        url='http://www.linkedin.com/in/bfriedland', 
        sort_order = sort_order,
    )
    ...
    ImportantLink.objects.create(
        description='Older Code Samples', 
        url='http://www.bugben.com/samples', 
        sort_order = sort_order,
    )
